...
i.scalar_wolfe:{[derphi_fnc;phi_fnc;pk;d]
 ...
 $[i.wolfe_crit_2[d];
   ...
   0<=d[`derphi_a1];
     [d[`i]:0w;d[i.new_zoom]:zoom_setup d[`alpha1`alpha0`phi_a1`phi_a0`derphi_a1]];
...
i.zoom:{[derphi_fnc;phi_fnc;phi0;derphi0;d]
  ...
  // third condition, then update and continue in loop
   i.zoom_crit_3[derphi_min;dalpha];
    [d[`i]+:1;d[i.upd_zoom1,i.upd_zoom2]:d[`phi_hi`a_hi`a_lo`phi_lo],fnd_min,phi_min,derphi_min`derval];
